...
const struct NaglowekBur naglowek = {
    {'B', 'U', 'R', '\0'},
    (uint64_t)&_start,
    4096,  8192, 0x401000, // Kod powłoki zajmuje do 8 KB (2 strony)
    12288, 8192, 0x403000  // Dane przesunięte na offset 12 KB, pojemność do 8 KB
};
...
// Zaawansowane manipulacje na plikach (BWS-7 i BWS-8)
...
extern "C" void _start() {
    print("\n");
    print("==================================================\n");
    print(" Powłoka Bursztynowa v1.7 (Ring 3 - Sieć)\n");
    ...
    while (true) {
        ...
        if (strcmp(bufor_komendy, "pomoc")) {
            ...
            print("  ping [IP]     - wysyła sygnał PING do sieci (np. ping 10.0.2.2)\n");
            ...
            print("Składnia polecenia: ping [adres IP] (np. ping 10.0.2.2)\n");
        }
            ...
            print("Sygnał został wysłany kablem sieciowym! Zobacz główne logi systemu, by odczytać wynik.\n");
        }
        else if (strcmp(bufor_komendy, "czas")) {
            char bufor_czasu[32];
            bws_wywolaj(9, (uint64_t)bufor_czasu);
            ...
            print("Dysk: Bursztynowy System Plików (BSP64), Bloki 4KB\n");
            print("Sieć: Intel E1000 (Zintegrowana karta), PING ICMP gotowy!\n");
            print("Ochrona: Poziomy Zaufania Bursztyna (PZB) Aktywne.\n");
        }
        else if (strcmp(bufor_komendy, "wersja")) {
            print("Powłoka Bursztynowa v1.7 (Build: Ring 3 Freestanding z obsługą Sieci)\n");
        }
            ...
            if (czytaj_plik("/logi/pci.txt", buf_pci, 2047)) {
                ...
                print("Błąd: Brak raportu PCI w systemie plików (Ring 0 nie przekazał logu).\n");
            }
        }
            ...
            if (wynik == 0) {
                print("Błąd: Nie udało się załadować programu z dysku (zła ścieżka lub brak uprawnień).\n");
            }
        }
        else if (strcmp(bufor_komendy, "gdzie")) {
            print("Obecna lokalizacja: / (Korzeń Systemu Plików)\n");
        }
            ...
            if (czytaj_plik("/cytaty.txt", buf, 511)) {
                ...
                print("Tworzę domyślny plik /cytaty.txt...\n");
            ...
            if (wylistuj_katalog(sciezka, buf, 511)) {
                print("Zawartość źródła ("); print(sciezka); print("):\n");
                print(buf);
            } else {
                print("Błąd: Katalog nie istnieje lub jest pusty.\n");
            }
        }
            ...
            else print("Błąd: Zablokowane przez PZB lub błędna ścieżka.\n");
        }
